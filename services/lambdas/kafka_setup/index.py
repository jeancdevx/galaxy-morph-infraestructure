...
Creates galaxy.ingestion and galaxy.results topics in MSK Serverless
idempotently. Invoked synchronously via aws_lambda_invocation from Terraform
...
_PARTITIONS: int = int(os.environ.get("TOPIC_PARTITIONS", "24"))
_REPLICATION: int = int(os.environ.get("TOPIC_REPLICATION_FACTOR", "3"))

_TOPICS_CONFIG: list[dict[str, str]] = [
    {
        "name": os.environ.get("INGESTION_TOPIC_NAME", "galaxy.ingestion"),
        "retention_ms": os.environ.get("INGESTION_RETENTION_MS", "604800000"),
    },
    {
        "name": os.environ.get("RESULTS_TOPIC_NAME", "galaxy.results"),
        "retention_ms": os.environ.get("RESULTS_RETENTION_MS", "259200000"),
    },
]
    ...
    for attempt in range(1, retries + 1):
        try:
            return KafkaAdminClient(
                ...
                client_id="galaxy-morph-kafka-setup",
