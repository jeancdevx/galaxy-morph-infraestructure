...
Repositorio de infraestructura y servicios para Galaxy Morph, una plataforma
distribuida para clasificacion de morfologia de galaxias.
...
- [services/](services): codigo de servicios (Lambdas, Spark/EMR, SageMaker,
  Kafka tools).
...
- [docs/galaxy_morph_architecture_knowledge.md](docs/galaxy_morph_architecture_knowledge.md):
  base de decisiones y contexto tecnico.
- [docs/project_execution_flow.md](docs/project_execution_flow.md): flujo
  completo del proyecto, etapas y servicios.
- [docs/contribution_workflow.md](docs/contribution_workflow.md): convenciones
  de contribucion, commits y PR.
- [docs/implementation_roadmap.md](docs/implementation_roadmap.md): roadmap
  quincenal con owners, entregables y Definition of Done por etapa.
...
Ejecutar la Q2 del roadmap: bootstrap de estado remoto Terraform, bloqueo de
estado y validacion en CI.

docker pull bridgecrew/checkov:3 docker run --rm -v ./iac:/tf --workdir /tf
bridgecrew/checkov:3 --directory /tf -o junitxml --output-file-path results.xml

## pasos para ejecutar

fase 1: en tfvars: enable_msk_connect_connector = false
...
cat > client.properties << 'EOF' security.protocol=SASL_SSL
...
fase 3: en tfvars: enable_msk_connect_connector = true # ← cambiar
...
fase 6: SAGEMAKER_ENDPOINT_NAME="galaxy-morph-dev-galaxy-classifier"
